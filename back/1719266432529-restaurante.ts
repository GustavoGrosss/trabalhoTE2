...
export class Restaurante1719266432529 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            ...
            ('1a2b3c4d-5678-90ab-cdef-1234567890ab', 'Restaurante A', 4, 'Rua das Flores, 123', 30, 'PRATOS')`);
        await queryRunner.query(
            `INSERT INTO restaurantes (id, nome, avaliacao, endereco, prazo_entrega, tipo)
             VALUES
                 ('2b3c4d5e-6789-01ab-cdef-234567890abc', 'Restaurante B', 5, 'Avenida Central, 456', 45, 'BEBIDAS')`);
        await queryRunner.query(
            `INSERT INTO restaurantes (id, nome, avaliacao, endereco, prazo_entrega, tipo)
             VALUES
                 ('3c4d5e6f-7890-12ab-cdef-34567890abcd', 'Restaurante C', 3, 'Praça das Árvores, 789', 25, 'DOCES')`);
        ...
        await queryRunner.query(
            `INSERT INTO pratos (id, nome, preco, proteina, vegano, avaliacao, restaurante_id)
             VALUES
                 ('4d5e6f7g-8901-23ab-cdef-4567890abcde', 'Prato A1', 29.90, 'GADO', false, 4, '1a2b3c4d-5678-90ab-cdef-1234567890ab');
            `);
        await queryRunner.query(
            `INSERT INTO pratos (id, nome, preco, proteina, vegano, avaliacao, restaurante_id)
             VALUES
                 ('5e6f7g8h-9012-34ab-cdef-567890abcdef', 'Prato B1', 34.50, 'SUINO', false, 5, '2b3c4d5e-6789-01ab-cdef-234567890abc')`);
        await queryRunner.query(
            `INSERT INTO pratos (id, nome, preco, proteina, vegano, avaliacao, restaurante_id)
             VALUES
                 ('6f7g8h9i-0123-45ab-cdef-67890abcdef0', 'Prato C1', 22.00, 'FRUTOS_DO_MAR', true, 3, '3c4d5e6f-7890-12ab-cdef-34567890abcd')`);
